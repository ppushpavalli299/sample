sap.ui.define([
    ...
    return BaseController.extend("project1.user.CreateUser", {
        ...
        onInit: function () {
            ...
            this.oRouter.getRoute("createUser").attachPatternMatched(this._onRouteMatched, this);
        ...
        handleFullScreen: function () {
            this.oRouter.navTo("createUser", { layout: "MidColumnFullScreen" });
        },
        ...
        onExit: function () {
            ...
            this.oRouter.getRoute("createUser").detachPatternMatched(this._onRouteMatched, this);
        },
